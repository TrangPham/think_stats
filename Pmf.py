...
class _DictWrapper(object):
    ...
    def Mode(self):
	"""Returns the value with the largest frequency/probability in the map."""
	return self.d.keys()[self.d.values().index(self.MaxLike())]	

    def AllModes(self):
	"""Returns a list of tuples of (value, frequency/probability) sorted by the frequency/probability."""
	getfreq = operator.itemgetter(1)
	return reversed(sorted(self.d.items(), key=getfreq))	
